 ...
 */
const TOKEN_REFRESH_RETRY_DELAY = 10000;
 ...
 *
 * @param integrationContext The integration context of the request.
...
export const getHyperproofAuthConfig = (
  ...
  return {
    ...
    hyperproofRedirectUrl: getHyperproofRedirectUrl(integrationContext),
...
export const addVendorUserIdToHyperproofUser = async (
  ...
  // The link will be created when the Hyperproof token is stored in integration storage.
